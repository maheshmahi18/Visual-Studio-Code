...
Last Two Bits of N Integers

The program must accept N integers as the input. The program must form a binary representation B by concatenating the last two bits of each integer among the N integers (left to right). Then the program must print the decimal equivalent of B as the output.
